...
(defun+ make-surface-from-pending (pending-surface)
  ...
  (with-slots (title
               ...
               no-frame hidden always-on-top legacy-gl-version)
      pending-surface
